...
const Privacy = () => {
    return(
        <div style={{color: "white", width:"70%", marginLeft:"15%"}}>
            ...
            <br/>
            <h1 style={{textAlign:"center"}}>Interpretation and Definitions</h1>
            <br/>
            ...
            <br/>
            <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to PlantPedia.</p><br/>
            </li>
            <li>
            ...
            <li>
            <p><strong>Country</strong> refers to: Berlin,  Germany</p><br/>
            </li>
            <li>
            ...
            <li>
            <p><strong>Website</strong> refers to PlantPedia, accessible from Plantpedia.org</p><br/>
            </li>
            <li>
            ...
            <h1 style={{textAlign:"center"}}>Collecting and Using Your Personal Data</h1><br/>
            ...
            <p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies: What Are Cookies?.</p><br/>
            ...
            <h1 style={{textAlign:"center"}} >Detailed Information on the Processing of Your Personal Data</h1><br/>
            ...
            <h2>Usage, Performance and Miscellaneous</h2><br/>
            <p>We may use third-party Service Providers to provide better improvement of our Service.</p><br/>
            <ul>
            <li>
            <p><strong>FreshDesk</strong></p><br/>
            <p>FreshDesk is a customer support software. The service is operated by Freshworks, Inc.</p><br/>
            <p>FreshDesk service may collect information from Your Device.</p><br/>
            <p>The information gathered by FreshDesk is held in accordance with its Privacy Policy: https://www.freshworks.com/privacy/</p><br/>
            </li>
            </ul>
            <h1 style={{textAlign:"center"}}>Children's Privacy</h1><br/>
            ...
            <h1 style={{textAlign:"center"}}>Links to Other Websites</h1><br/>
            ...
            <ul>
            <li>By email: plantpedia.project@gmail.com</li><br/>
            </ul>
        </div>
    )
}
